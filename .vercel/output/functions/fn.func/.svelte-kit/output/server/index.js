...
import {
	...
	r as reset,
	p as public_env,
	s as safe_public_env,
	c as read_implementation,
	d as options,
...
import {
	...
	d as disable_search,
	n as normalize_path,
	a as add_data_suffix,
	r as resolve,
	b as decode_pathname,
	h as has_data_suffix,
	s as strip_data_suffix,
	c as decode_params,
	v as validate_layout_server_exports,
	e as validate_layout_exports,
	f as validate_page_server_exports,
	g as validate_page_exports,
	i as validate_server_exports
...
class BaseProvider {
	...
	constructor(use_hashes, directives, nonce) {
		...
		this.#style_needs_csp =
			this.#style_src_needs_csp || this.#style_src_attr_needs_csp || this.#style_src_elem_needs_csp;
...
${indent}}`);
		...
		const boot = client.inline
			? `${client.inline.script}
					...
					__sveltekit_${options2.version_hash}.app.start(${args.join(', ')});`
			: client.app
				? `Promise.all([
				...
				if (set_cookie) {
					for (const str of set_cookie_parser.splitCookiesString(set_cookie)) {
						...
						set_internal(name, value, {
							...
							.../** @type {import('cookie').CookieSerializeOptions} */ options3
						});
					}
				}
				return response;
