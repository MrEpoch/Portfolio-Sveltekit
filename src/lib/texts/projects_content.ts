...
const projects = [
	...
	},
  {
    ...
    description: "Designer portfolio made with intent of storing photos, designs and more, it was created with some beautiful animations in framer motion."
  },
  {
    ...
    description: "Construction company with basic pages like services, career, contact and about us, made with nextjs and optimized for performance."
  }
];
