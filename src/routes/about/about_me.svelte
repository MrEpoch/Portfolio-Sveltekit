...
<p class="dark:text-gray-100 text-gray-700 text-xl text-center">
    I am experienced with <a href="https://kit.svelte.dev/" class="bg-gradient-to-r from-indigo-400 to-cyan-400 text-lg
    font-bold bg-clip-text text-transparent box-decoration-clone">Sveltekit</a>
    and <a href="https://nextjs.org/" class="bg-gradient-to-r from-indigo-400 to-cyan-400 text-lg
        font-bold bg-clip-text text-transparent box-decoration-clone">Next.js</a> frameworks, on
    side i too made few projects backend with <a href="https://expressjs.com/" class="bg-gradient-to-r from-indigo-400 to-cyan-400 text-lg
    font-bold bg-clip-text text-transparent box-decoration-clone">Express.js</a>
</p>
<p class="dark:text-gray-100 text-gray-700 text-xl text-center">
    Mainly developing with <a href="https://www.typescriptlang.org/" class="bg-gradient-to-r from-indigo-400 to-cyan-400 text-lg
    font-bold bg-clip-text text-transparent box-decoration-clone">Typescript</a>
    and <a href="https://tailwindcss.com/" class="bg-gradient-to-r from-indigo-400 to-cyan-400 text-lg
